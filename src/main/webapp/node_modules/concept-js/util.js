...
Util.prototype.showLoading = function(){
	nav.loadJSP('includes/loading.jsp', function(resp){
		var props = {};
		props.size = 'large';
		props.closable = 'false';
		page.showModal2(resp, function() {
			$('.spiner-example').css('padding-top', screen.height-650);
			$('.spiner-example').closest('.modal-content').removeClass('modal-content');
			$('.spiner-example').show();
			page.init();
			$('.modal-backdrop.in.fade').addClass('spinner-loading');
			
		}, props);
	 }); 
}

Util.prototype.hideLoading = function(callback	){
	$('#theModal2 .my-modal-content').addClass('modal-content');
	$("#theModal2").modal('hide');
	$('.spiner-example').hide();
	if (typeof(callback) == "function") {
		callback();
	}
	$('.modal-backdrop').removeClass('spinner-loading');
}
