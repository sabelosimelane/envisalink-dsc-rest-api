                ...
                <div class="mail-body">
                    <form id="thisform" class="form-horizontal">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Public:</label>
							...
							<div class="col-sm-10"><input name="isPublic" type="checkbox" class="js-switch" /></div>
                        </div>
                        <concept:fileupload param1="DISCUSSION" ></concept:fileupload>
                        </form>
                </div>
